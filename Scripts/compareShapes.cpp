...
void compareShapes(){
    ...
    plot(g_canvas, "/Users/user/Documents/HEP/VBF-Analysis/MuMu/Plots/Z-peak/SR/Zmumu_MGRW.root", "mass_jj", "Standard RW - EWjj Sherpa",kRed, "SAME HIST P E1");
    plot(g_canvas, "/Users/user/Documents/HEP/VBF-Analysis/MuMu/Plots/Z-peak/SR/Zmumu_MGRW-Alternative.root", "mass_jj", "Alternative RW - EWjj PoPy + SF",kBlue, "SAME HIST P E1");
