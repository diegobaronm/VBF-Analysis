...
if __name__ == '__main__':
    ...
    # Alert that the BSM version of the script is being run.
    print("ALERT!!!!")
    print("You are running the BSM version of the script")
    ...
    systematic_uncertainty_value_signal = args.signalExpected * (args.systematicUncertaintySignal / 100.0)
    signal_totalExpectedE_with_systematic = np.sqrt(args.signalExpectedE**2 + systematic_uncertainty_value_signal**2)
    print(f"Total expected events: {args.totalExpected} ± {args.totalExpectedE}")

    # Calculate the 95% CL upper limit
    upper_limit = calculate_limit(args.totalExpected, args.totalExpectedE, args.toys)
    ...
    adjusted_signal_expectedE = signal_totalExpectedE_with_systematic * (1 - args.zPeakContamination / 100.0)
    ...
    result = (upper_limit - args.totalExpected)/adjusted_signal_expected
    ...
    print("ALERT!!!!")
    print("You used the BSM version of the script")
