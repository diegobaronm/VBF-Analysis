...
def compareShapesFromDifferentFiles(histogramName, histogramTemplate, prefix, postfix, dictOfFiles, useDensity):
    ...
    c.SetMargin(0.16,0.12,0.13,0.08)
    # Plot histograms
    for i in range(len(dictOfFiles)):
    ...
    # Add legend
    legend = c.BuildLegend(0.6,0.80,0.98,0.98)
...
def main():
    ...
    FILE_DICT = [
        {"path" : "/Users/user/Documents/HEP/VBF-Analysis/VBFAnalysisPlots/TauTau/Zpeak/BDT5FoldsOS/Signal_truth_MG.root", "title" : "MadGraph"},
        {"path" : "/Users/user/Documents/HEP/VBF-Analysis/VBFAnalysisPlots/TauTau/Zpeak/BDT5FoldsOS/Signal_truth_Sherpa.root", "title" : "Sherpa2.2.14"},
        {"path" : "/Users/user/Documents/HEP/VBF-Analysis/VBFAnalysisPlots/TauTau/Zpeak/BDT5FoldsOS/Signal_truth_PoPy.root", "title" : "Powheg+Pythia8"},
    ]
    ...
    for histoName in listOfHistograms:
        compareShapesFromDifferentFiles(histoName, histoName, PREFIX, POSTFIX, FILE_DICT, True)
