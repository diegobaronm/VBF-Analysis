...
def stackPlot(data,signal,background,histograms,watermark,
    ...
    # Run ROOT in batch mode to avoid opening canvases and capturing the screen
...
HistogramInfo('pt_bal', [0.15, 0.3], [0.03, 0.05, 0.7], 0.15, 'pT balance',0,0.15,''),
HistogramInfo('Z_centrality', [0.5], [0.1, 0.5], 0.1, '#xi(Z)',0,1.0,'',xRange=[0,2]),
HistogramInfo('delta_y', [2.0, 6.0], [2.0, 0.5, 4.0], 1.0, '#Deltay_{jj}',2.0,10.0,''),
...
tautauHighMassValidationHistograms = [
HistogramInfo('n_bjets_basic_all', [], [], 1.0, 'n_bjets',0,0,'',logScale=True),
HistogramInfo('lepiso_basic_all', [], [], 1.0, 'lepiso',0,0,''),
HistogramInfo('n_jets_interval_basic_all', [], [], 1.0, 'N gap jets',0,0,'',xRange=[0,2],isIntegerPlot=True),
HistogramInfo('nLightJets_basic_all', [], [], 1.0, 'nLightJets_basic_all',0,0,''),
HistogramInfo('tau_pt_basic_all', [25.0, 125.0, 150.0], [25.0, 20.0, 25.0, 350.0], 25.0, 'pT(#tau)',0,0,'GeV'),
HistogramInfo('lep_pt_basic_all', [27, 97, 297], [27, 35, 100, 203], 27, 'pT(l)',0,0,'GeV'),
HistogramInfo('delta_phi_basic_all', [1.8], [0.9, 0.7], 0.7, '#Delta#phi(#tau,l)',0,0,''),
HistogramInfo('delta_y_basic_all', [6.0], [2.0, 4.0], 2.0, '#Deltay_{jj}',0,0,''),
HistogramInfo('omega_basic_all', [-0.2, 0.0, 0.6, 1.0, 1.6], [1.4, 0.2, 0.3, 0.2, 0.29999, 1.4], 0.2, '#Omega',0,0,''),
HistogramInfo('rnn_score_1p_basic_all', [0.15, 0.25, 0.4], [0.15, 0.1, 0.15, 0.3], 0.1, 'jetRNN Score 1p',0,0,''),
HistogramInfo('rnn_score_3p_basic_all', [0.25, 0.55, 0.8], [0.25, 0.15, 0.25, 0.2], 0.15, 'jetRNN Score 3p',0,0,''),
HistogramInfo('ljet0_pt_basic_all', [75, 375, 625], [75, 100, 125, 375], 75, 'pT(j_{1})',0,0,'GeV',True),
HistogramInfo('ljet1_pt_basic_all', [70, 370, 630], [70, 100, 130, 370], 70, 'pT(j_{2})',0,0,'GeV',True),
HistogramInfo('pt_bal_basic_all', [0.15], [0.03, 0.85], 0.03, 'pT balance',0,0,''),
HistogramInfo('Z_centrality_basic_all', [0.2, 0.5, 2.0], [0.2, 0.3, 1.5, 3.0], 0.2, '#xi(Z)',0,0,'',xRange=[0,2]),
HistogramInfo('mass_jj_basic_all', [1000, 2500], [250, 750, 1250], 250, 'm_{jj}',0,0,'GeV',True),
HistogramInfo('reco_mass__basic_all', [66, 81, 101, 116, 160, 250, 500], [66, 15, 10, 15, 11, 30, 125, 250], 10, 'm_{#tau,l}',160,1000,'GeV',True),
HistogramInfo('Z_pt_reco_i_basic_all', [300], [50, 100], 50, 'pT(Z)',0,0,''),
HistogramInfo('Z_pt_reco_o_basic_all', [300], [50, 100], 50, 'pT(Z)',0,0,''),
HistogramInfo('bdtScore_basic_all', [-0.4, 0.1, 0.5], [0.2, 0.25, 0.2, 0.25], 0.2, 'VBF-BDT score',0,0,'',xRange=[-1.0,0.99999]),
HistogramInfo('pTsymmetry_basic_all', [0.4], [0.2, 0.2], 0.2, 'p_{T} asymmetry',0,0,''),
HistogramInfo('lepTransMass_basic_all', [60, 100, 200], [30, 40, 100, 150], 30, 'm_{T}(l)',0,0,'GeV'),
HistogramInfo('tauTransMass_basic_all', [100, 200], [20, 50, 50], 20, 'm_{T}(#tau)',0,0,''),
HistogramInfo('recoVisibleMassRatio_basic_all', [1.0, 2.0,4.0], [0.2, 0.5, 1.0,2.0], 0.2, 'm(reco)_{#tau,l}/m(vis)_{#tau,l}',0,0,''),
HistogramInfo('met_basic_all',[20,40,100,200],[20,10,30,100,150],20,'MET',0,0,'GeV'),
]
...
templatesDict = {
    ...
    'tautauHighMassValidationHistograms' : tautauHighMassValidationHistograms,
    'tautauHighMassMJHistograms' : tautauHighMassMJHistograms,
    'tautauHiggsHistograms' : tautauHiggsHistograms,
    'tautauHiggsNoBDTHistograms' : tautauHiggsNoBDTHistograms,
