...
try :
	...
	if type_of_run==1:
		...
		os.system('hadd '+channel_dir+'MC/out/Zee_MG.root NOMINAL/Zee_MG*.root')
		os.system('hadd '+channel_dir+'MC/out/Zee_MGNLO.root NOMINAL/Zee_MGNLO*.root')
		os.system('hadd '+channel_dir+'MC/out/Zee_SherpaNLO.root NOMINAL/Zee_SherpaNLO*.root')
