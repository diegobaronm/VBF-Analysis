...
try :
	...
	if type_of_run==1:
		...
		os.system('hadd -j 10 '+channel_dir+'MC/out/Signal_PoPy.root NOMINAL/VBF_Zee_201*.root')
		os.system('hadd -j 10 '+channel_dir+'MC/out/Ztautau_PoPy.root NOMINAL/Ztautau_*.root')
		os.system('hadd -j 10 '+channel_dir+'MC/out/Zmumu.root NOMINAL/Zmumu_201*.root')
		...
		for d in os.listdir():
			if d!="Systematics":
				os.system("hadd -j 10 Systematics/Signal_Sherpa_"+d+".root "+d+"/VBF_Zee*"+d+".root")
				os.system("hadd -j 10 Systematics/Zee_SherpaRW_"+d+".root "+d+"/Zee_sherpa*"+d+".root")
