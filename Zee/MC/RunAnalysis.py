...
from AnalysisCommons.Metadata.infofileZee import infos
from AnalysisCommons.Metadata.datasetsZee import dataSets, realList, dataCombos, dirs
from AnalysisCommons.Metadata.OutputPaths import Zee_outputs_path
...
def runAnalysis(key, remote, args):
    ...
    MoveOutput(output_name, tree_name, remote, output_dict = Zee_outputs_path, cli_path=args.output)
