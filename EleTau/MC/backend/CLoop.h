...
class CLoop {
  ...
  void FillTree(double weight, int z_sample, const std::string& sampleName, double mjj, bool isData, TTree* stree, TTree* btree);
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(double lumFactor, int z_sample, const std::string& key, int logLevel, const std::string& mode);
