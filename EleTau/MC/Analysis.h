...
double pi=TMath::Pi();
std::vector<std::string> cutNames{"basic","dphi","drap","btag","iso","rnn","ptl","j1pt","j2pt","ptbal","mjj","nji","zcen","omega","mlt","ebdt","mreco","tpt","mva","lepnupt","ptsym","taunupt","rvr","met"};
