...
from AnalysisCommons.Metadata.OutputPaths import Zem_outputs_path
...
def runAnalysis(key, remote, args):
    ...
    MoveOutput(output_name, tree_name, remote, output_dict = Zem_outputs_path, cli_path=args.output)
