...
# define DECLARE_SYS_HISTOGRAMS(systematic_name_begin, systematic_name_end) \
  TH1F* h_mass_jj_##systematic_name_begin##_1down_##systematic_name_end; \
  TH1F* h_mass_jj_##systematic_name_begin##_1up_##systematic_name_end; \

# define DEFINE_SYS_HISTOGRAMS(systematic_name_begin, systematic_name_end) \
  h_mass_jj_##systematic_name_begin##_1down_##systematic_name_end = new TH1F("mass_jj_"#systematic_name_begin"_1down_"#systematic_name_end,"Invariant mass di-jet system",5000,0,5000); \
  h_mass_jj_##systematic_name_begin##_1up_##systematic_name_end = new TH1F("mass_jj_"#systematic_name_begin"_1up_"#systematic_name_end,"Invariant mass di-jet system",5000,0,5000); \
